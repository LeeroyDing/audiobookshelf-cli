...
## [1.2.1] - 2026-04-20
### Fixed
- **CI/CD Pipeline**: Migrated to GoReleaser for more robust cross-platform releases, using the stable pattern from seerr-cli.

## [1.2.0] - 2026-04-20
### Changed
- **Rewrite in Go**: Completely rewrote the CLI from Rust to Go for improved build performance and easier maintenance.
- **CLI Framework**: Switched to Cobra for better command management and autocompletion.
- **Build System**: Migrated CI/CD workflows to Go-based actions.

## [1.1.1] - 2026-04-19

### Fixed
- **CI/CD Pipeline**: Fixed formatting issue in E2E tests and corrected binary name in release workflow.
